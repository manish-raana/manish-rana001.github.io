...
$(document).ready(function(){
  ...
  if(isAndroid > -1)
  {
   $('.howto').hide();
   $('.howto-android').show();
   $('head').append('<link rel="stylesheet" href="../assets/css/zeus-android.css" />');
  }     
});
...
$('#sendpic').click(function(e){
  e.preventDefault();
  $('#chatWindow').append($('#sendpicC'));
  $(".user-reply").removeClass("send");
  //$('#chatWindow').html("<div class='user-reply'><div class='chatBbl msent'><div class='imgatch'><img src='#' alt='' id='upimg2' /></div></div> <div class='chat-avatar'><img src='assets/images/male-user.jpg' alt='' /></div></div>");
...
$(function(){
    ...
    var $window = $(window).on('resize', function(){
      // var height2 = $mainc2.height() - $header.height() - 150;
       var height2 = $mainc2.height() - $header.height() - 100;
...
$(document).ready(function() {
  ...
  if (i.val().length > 0) {
        ...
        setTimeout(function(){ $("#typing").show(); $('.cr-inner').animate({scrollTop: 5300}); }, 1000);            
